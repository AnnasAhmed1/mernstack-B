                    ...
                    <View style={styles.headerStyle}>
                        <View style={styles.forgotContainer}>
                            ...
                            <View style={styles.crossIconContainer}>
                                <Icon name='close' type="fontawesome" onPress={requestmodalclose} />
                            </View>
                        </View>
                    </View>
...
const styles=StyleSheet.create({
    ...
    headerStyle: {flex:1, flexDirection:'column',backgroundColor:colors.WHITE.default, justifyContent:"center"},
    forgotPassText: {textAlign:"center",color:'black',fontSize:20,width:"100%"},
