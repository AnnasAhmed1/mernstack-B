...
export default class DriverStartTrip extends React.Component {
    ...
    componentWillMount() {
       ...
       //  alert("track num:"+ item.bookingUid)
        this.setState({
    ...
    chat(){
       // console.log("chat here");
        // console.log(this.state.tripInfo);
          obj = {
         "bookingId": this.state.rideDetails.bookingId,
         "mainKey":this.state.rideDetails.customer + ',' + this.state.rideDetails.driver
      }
        //this.state.rideDetails.mainKey = this.state.rideDetails.driver + ',' + firebase.auth().currentUser.uid
        this.props.navigation.navigate("Chat",{passData:obj});
    }
    ...
    return (
        ...
        <View style={styles.containerView}>
            <Header 
                ...
                centerComponent={<Text style={styles.headerTitleStyle}>{'Tracking Screen'}</Text>}
