export default {
    ...
    request_title_placeholder: "Request Title",
    login_button:"Login",
    register_link:"Register",
    forgot_password_link:"Forgot Password?",
    facebook_login_button:'Facebook',
    ...
    static_notification_title:'Beeslink Notification',
    ...
    first_name_blank_error:"Required Field",
    last_name_placeholder:'Last Name',
    last_name_blank_error:'Required Field',
    ...
    book_your_ride_menu:'Map',
    open_request:'Open New Request',
    ...
    open_request_button:'Post',
    open_request_title:'New Request',
    request_title: 'Title',
    //request_description: 'Tap here and describe the situation',
    request_description: 'Please describe the situation and what you are looking for. ',
    map_screen_where_input_text:'Where From ?',
    map_screen_drop_input_text:'Drop Where ?',
    driver_finding_alert:'Searching for people…',
    no_driver_found_alert_title:'Alert!',
    no_driver_found_alert_messege:'Messages have been sent to people around you and you will be notified as soon as there it a person available. You can always check the status of your request in "My Requests"',
    ...
    map_screen_title:'Grab My Taxi6',
    ...
    ride_details_page_title:'Request Details',
    ...
    call_driver:'Call Beeplink man',
    booked_cab_title:'Tracking Screen',
    you_selected:'You Selected -',
    otp:'OTP :',
    driver_assign_messege:'Driver will Assign Soon..',
    cancel_ride:'Close Request',
    rider_cancel_text:'Request Cancel',
    cancel_messege1:'Your request with Booking Id',
    cancel_messege2:'has been cancelled successfully',
    dont_cancel_text:'Don\'t Close',
    cancel_reason_modal_title:'What\'s Close Reason',
    chat_title:'Chat',
    send_button_text:'Send',
    chat_input_title:'Type something...',
    ...
    skip:'Skip',
    receipt:'Receipt',
    rate_ride:'PLEASE RATE THE WORK',
    err:'Error!',
    route_not_found:'Cannot found any route',
    sorry:'Sorry',
    multipleBooking:'Beeplink currently doesn\'t support multiple bookings.',
    driver_not_found:'We cannot assign driver at this moment. contact to adminstrator !!',
    new_booking_request_push_notification:'You have a new request to accept',
    ...
    Balance:'BeepLink Balance',
    android_channel: 'Beeplink Notifications',
    request_title_blank_error:"Please enter a Title.",
    accept_offer: "Accept",
    select_offer:"bla bla"
}
