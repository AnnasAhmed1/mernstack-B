    ...
    render(){
        ...
        >
            ...
            <View style={{backgroundColor:'#fff',width:'90%',height:250,justifyContent:'center',alignItems:'center',marginLeft:18,marginRight:10,marginTop:150}}>
              <View style={{width:'100%',justifyContent:'space-between',alignItems:'center',flex:1.5,flexDirection:'row',paddingRight:12}}>
                <View></View>
...
const styles=StyleSheet.create({
    ...
    forgotPassText: {textAlign:"center",fontSize:20,},
