...
import { StyleSheet,Text, View, TouchableOpacity, TouchableWithoutFeedback, PermissionsAndroid, StatusBar, Image } from 'react-native';
...
import a2red from "../../assets/images/rsz_2red_pin.png";
import trackCar from "../../assets/images/rsz_2red_pin.png";
                ...
                if(data){
                    this.setState({
                        ...
                        if(bookingStatus == 'ACCEPTED'){
                            var distance = getDistance(paramData.wherelatitude,paramData.wherelongitude, data.lat,data.lng );
                                ...
                                if(!this.state.allData.flag){
                                    ...
                                    dat.once('value',snapshot=>{
                                        if(snapshot.val() && snapshot.val().pushToken){
                                            //alert(77)
                                            RequestPushMsg(snapshot.val().pushToken,'Beeplink man Near you')
                                            paramData.flag = true;
                                        }
                                        })
                                }
